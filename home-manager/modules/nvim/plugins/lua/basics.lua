...
table.insert(plugins, {
  ...
  setup = function()
    ...
    vim.keymap.set({ "n", "x" }, "%", "<plug>(matchup-%)", { desc = "vim-matchup" })
  end,
  config = function() end,
})
...
table.insert(plugins, {
  ...
  setup = function() end,
  config = function()
    vim.keymap.set("n", "<C-W>m", require("mini.misc").zoom, { desc = "maximize current window" })
    vim.keymap.set("n", "<C-W><C-M>", require("mini.misc").zoom, { desc = "maximize current window" })
  end,
})
